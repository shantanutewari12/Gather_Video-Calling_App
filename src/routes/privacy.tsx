      ...
      <div className="mx-auto max-w-3xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 space-y-8 text-white/70 leading-relaxed">
          ...
          <section>
            ...
            <p>We do not store, record, or process your video or audio streams. All media is peer-to-peer (WebRTC) and never touches our servers.</p>
          </section>
          <section>
            <h2 className="mb-3 text-xl font-bold text-white">3. Cookies</h2>
            <p>We use minimal session cookies to maintain your display name within a browser tab. We do not use tracking cookies.</p>
          </section>
          <section>
            <h2 className="mb-3 text-xl font-bold text-white">4. Third-Party Services</h2>
            <p>Gather uses Supabase for real-time signaling and chat persistence. Vercel for hosting. Neither service receives your media streams.</p>
          </section>
          <section>
            <h2 className="mb-3 text-xl font-bold text-white">5. Data Retention</h2>
            <p>Chat messages are retained for 30 days, then permanently deleted. Meeting metadata (room codes) may be retained for up to 90 days for abuse prevention.</p>
          </section>
          <section>
            <h2 className="mb-3 text-xl font-bold text-white">6. Your Rights</h2>
            <p>You may request deletion of any data associated with a meeting you created. Contact us via our <Link to="/report-bug" className="text-violet-400 underline hover:text-violet-300">support form</Link>.</p>
          </section>
        </div>
      </div>
    </div>
