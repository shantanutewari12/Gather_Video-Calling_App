      ...
      <div className="mx-auto max-w-3xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 space-y-8 leading-relaxed text-white/70">
          <section>
            ...
            <p>
              By accessing or using Gather, you agree to be bound by these Terms of Service. If you
          ...
          <section>
            ...
            <p>
              Gather provides an instant, no-login video conferencing service. Rooms are ephemeral —
              no data is stored beyond the session. All communication is peer-to-peer (WebRTC) and
          ...
          <section>
            ...
            <p>
              You agree not to use Gather for any unlawful purpose, to harass, abuse, or harm
              others, or to transmit any content that violates applicable laws. We reserve the right
              to terminate access for violations.
            </p>
          </section>
          <section>
            <h2 className="mb-3 text-xl font-bold text-white">4. Intellectual Property</h2>
            <p>
              All content, trademarks, and software on this platform belong to Gather Technologies.
              You may not copy, modify, or distribute any part of the platform without written
              permission.
            </p>
          </section>
          <section>
            ...
            <p>
              Gather is provided &quot;as-is&quot; without any warranties. We are not liable for any
          ...
          <section>
            ...
            <p>
              We may update these terms at any time. Continued use of Gather after changes
